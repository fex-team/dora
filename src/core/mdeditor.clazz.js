...
(function () {
    ...
    Class.prototype.base = function (name) {
        ...
        var method = caller.__MdeditrorMethodClass.__MDeditorBaseClass.prototype[ name ];
    ...
    function inherit(constructor, BaseClass, classname) {
        var MDeditorClass = eval('(function MDeditor' + classname + '( __inherit__flag ) {' +
        ...
        MDeditorClass.prototype = new BaseClass(FINDER_INHERIT_FLAG);
    ...
    MD.createClass = function (classname, defines) {
        ...
        NewClass.__MDeditorMethodNames = constructor.__MDeditorMethodName = 'constructor';
